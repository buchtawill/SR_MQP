...
#define SLIDER_WIDTH_IN 6 //6 accounts for 1 pixel buffer on each side
#define SLIDER_HEIGHT_IN 6 //6 accounts for 1 pixel buffer on each side
#define SLIDER_WIDTH_WO_BUFFER 4
#define SLIDER_HEIGHT_WO_BUFFER 4
#define SLIDER_WIDTH_OUT (SLIDER_WIDTH_WO_BUFFER * SCALE_FACTOR)
#define SLIDER_HEIGHT_OUT (SLIDER_HEIGHT_WO_BUFFER * SCALE_FACTOR)
#define NUM_SLIDERS_WIDTH (WIDTH_IN / SLIDER_WIDTH_WO_BUFFER)
#define NUM_SLIDERS_HEIGHT (HEIGHT_IN / SLIDER_HEIGHT_WO_BUFFER)
#define NUM_SLIDERS (WIDTH_IN * HEIGHT_IN / SLIDER_WIDTH_WO_BUFFER / SLIDER_HEIGHT_WO_BUFFER)
